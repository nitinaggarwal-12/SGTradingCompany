      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 space-y-12">
        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div className="max-w-2xl space-y-3">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-600 dark:text-amber-400 font-mono-spec text-xs font-extrabold uppercase">
        ...
        {activeSimulator === "cold-chain" && (
          <div className="industrial-card rounded-3xl p-6 md:p-10 border-2 border-amber-500/50 shadow-2xl space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              {/* Telemetry Control Panel */}
              <div className="lg:col-span-5 space-y-6">
                <div>
                  <span className="text-xs font-mono-spec font-extrabold text-amber-600 dark:text-amber-400 uppercase">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-sky-500/10 border border-sky-500/30 font-mono-spec">
                    ...
                    <div className="text-3xl font-black mt-2 text-sky-700 dark:text-sky-300">
                      -18.4°C
                    </div>
                  ...
                  <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 font-mono-spec">
                    ...
                    <div className="text-3xl font-black mt-2 text-amber-700 dark:text-amber-300">
                      +2.8°C
                    </div>
                ...
                <div className="space-y-2 pt-2">
                  <div className="flex justify-between text-xs font-mono-spec font-bold">
                    ...
                    <span className="text-amber-500">{vanRouteProgress}% Arrived</span>
                  </div>
                  <input
                    type="range"
                    min="10"
                  ...
                  />
                  <div className="flex justify-between text-[10px] font-mono-spec text-slate-500">
              ...
              {/* 3D Visual Route & Van Graphic Simulation */}
              <div className="lg:col-span-7 relative p-6 md:p-8 rounded-3xl bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 border border-slate-800 text-white overflow-hidden shadow-inner">
                <div className="flex items-center justify-between pb-4 border-b border-slate-800 text-xs font-mono-spec">
                ...
                {/* Route Milestones */}
                <div className="grid grid-cols-3 gap-4 pt-6 text-xs font-mono-spec">
                ...
                <div className="space-y-3 pt-2 text-xs font-mono-spec">
                  <div className="p-3.5 rounded-xl border border-amber-500/40 bg-amber-500/10">
                    ...
                    <p className="text-slate-700 dark:text-slate-300 mt-1">
                      Retains structural crispiness up to **26 minutes** under heat lamps. Ideal for 5-star banquets &amp; dine-in QSRs.
                    </p>
                  </div>

                  <div className="p-3.5 rounded-xl border border-sky-500/40 bg-sky-500/10">
                    <span className="font-extrabold text-sky-600 dark:text-sky-400 block">
                      🍟 Iscon Balaji 9mm Fries (₹340 / 2.5 Kg)
                    </span>
                    <p className="text-slate-700 dark:text-slate-300 mt-1">
                      ₹40 lower per pack cost with **19-minute** crisp retention. Gives cloud kitchens a 14% higher net profit margin.
                    </p>
                  </div>
                </div>
              </div>

              {/* Animated 3D Comparison Bar Graphic */}
              <div className="lg:col-span-7 p-6 rounded-3xl bg-slate-900 border border-slate-800 text-white space-y-6">
                <div className="flex justify-between items-center text-xs font-mono-spec border-b border-slate-800 pb-3">
                  <span className="text-amber-400 font-bold">
                    CRISP RETENTION DURATION (MINUTES UNDER HEAT LAMP)
                  </span>
                  <span className="text-slate-400">Higher = Longer Crispiness</span>
                </div>
                ...
                <div className="space-y-5 py-4">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs font-mono-spec font-bold">
                      ...
                      <span className="text-amber-400 font-black">26 MINS CRISP</span>
                    </div>
                    <div className="w-full h-8 bg-slate-800 rounded-xl overflow-hidden p-1">
                      <div
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs font-mono-spec font-bold">
                      ...
                      <span className="text-sky-400 font-black">19 MINS CRISP (HIGH MARGIN)</span>
                    </div>
                    <div className="w-full h-8 bg-slate-800 rounded-xl overflow-hidden p-1">
                      <div
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 p-6 rounded-3xl bg-slate-900 border border-slate-800 text-white space-y-6">
                <div className="flex justify-between items-center text-xs font-mono-spec border-b border-slate-800 pb-3">
                  ...
                  <span className="text-emerald-400 font-bold">● CHEF CERTIFIED</span>
                </div>

                <div className="grid grid-cols-3 gap-4 text-center font-mono-spec py-4">
                  <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800">
                    <span className="text-slate-400 text-xs block">Oven Melt Temp</span>
                  ...
                  <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800">
                    <span className="text-slate-400 text-xs block">Cheese Pull</span>
                  ...
                  <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800">
                    <span className="text-slate-400 text-xs block">GST Input Credit</span>
