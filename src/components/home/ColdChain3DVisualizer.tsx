...
export const ColdChain3DVisualizer: React.FC = () => {
  ...
  return (
    <section className="w-full py-16 md:py-24 border-b border-slate-800 bg-slate-950 text-white transition-colors">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 space-y-12">
        {/* Header */}
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div className="max-w-2xl space-y-3">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-400 font-mono-spec text-xs font-extrabold uppercase">
        ...
        {activeSimulator === "cold-chain" && (
          <div className="rounded-3xl p-6 md:p-10 border-2 border-amber-500/60 bg-slate-900 shadow-xl space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              {/* Telemetry Control Panel */}
              <div className="lg:col-span-5 space-y-6">
                <div>
                  <span className="text-xs font-mono-spec font-extrabold text-amber-400 uppercase">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-5 space-y-4">
                ...
                <div className="space-y-3 pt-2 text-xs font-mono-spec">
                  <div className="p-3.5 rounded-xl border border-amber-500/50 bg-amber-500/10">
                    <span className="font-extrabold text-amber-400 block">
                      🍟 McCain 9mm French Fries (₹380 / 2.5 Kg)
                    </span>
                    <p className="text-slate-300 mt-1">
                      Retains structural crispiness up to <strong className="text-amber-400">26 minutes</strong> under heat lamps. Ideal for 5-star banquets &amp; dine-in QSRs.
                    </p>
                  </div>

                  <div className="p-3.5 rounded-xl border border-sky-500/50 bg-sky-500/10">
                    <span className="font-extrabold text-sky-400 block">
                      🍟 Iscon Balaji 9mm Fries (₹340 / 2.5 Kg)
                    </span>
                    <p className="text-slate-300 mt-1">
                      ₹40 lower per pack cost with <strong className="text-sky-400">19-minute</strong> crisp retention. Gives cloud kitchens a 14% higher net profit margin.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-7 p-6 rounded-3xl bg-slate-950 border border-slate-800 text-white space-y-6">
                ...
                <div className="space-y-5 py-4">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs font-mono-spec font-bold">
                      <span className="text-white">McCain 9mm French Fries (2.5 Kg Institutional)</span>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs font-mono-spec font-bold">
                      <span className="text-white">Iscon Balaji 9mm Fries (2.5 Kg Export Pack)</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 p-6 rounded-3xl bg-slate-950 border border-slate-800 text-white space-y-6">
                <div className="flex justify-between items-center text-xs font-mono-spec border-b border-slate-800 pb-3">
                  ...
                  <span className="text-emerald-400 font-extrabold">● CHEF CERTIFIED</span>
                </div>
